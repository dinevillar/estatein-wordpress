    ...
    <div class="services-features__grid">
      <div class="service-feature-card">
        <div class="service-feature-card__header">
          <div class="service-feature-card__icon"><?php echo estatein_service_icon('squares-plus'); ?></div>
      ...
      <div class="service-feature-card">
        <div class="service-feature-card__header">
          <div class="service-feature-card__icon"><?php echo estatein_service_icon('swatch'); ?></div>
      ...
      <div class="service-feature-card">
        <div class="service-feature-card__header">
          <div class="service-feature-card__icon"><?php echo estatein_service_icon('sparkles'); ?></div>
