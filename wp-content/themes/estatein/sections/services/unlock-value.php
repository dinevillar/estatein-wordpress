...
<section id="unlock-value" class="services-features">
  <div class="container">
    ...
    <div class="services-features__grid">
      ...
      <div class="service-feature-card">
        <div class="service-feature-card__header">
          <div class="service-feature-card__icon"><?php echo estatein_service_icon('chart-pie'); ?></div>
      ...
      <div class="service-feature-card">
        <div class="service-feature-card__header">
          <div class="service-feature-card__icon"><?php echo estatein_service_icon('megaphone'); ?></div>
